...
INSERT INTO "new_SaleItem" ("discount", "id", "priceType", "productId", "productName", "quantity", "saleId", "selectedPrice", "total", "warehousesId") SELECT "discount", "id", "priceType", "productId", "productName", "quantity", "saleId", "selectedPrice", "total", "warehousesId" FROM "SaleItem";
DROP TABLE "SaleItem";
