/*
  ...
  - You are about to drop the `BalancePayment_online` table. If the table is not empty, all the data it contains will be lost.
...
-- DropForeignKey
ALTER TABLE "BalancePayment_online" DROP CONSTRAINT "BalancePayment_online_saleId_fkey";

-- DropForeignKey
ALTER TABLE "BalancePayment_online" DROP CONSTRAINT "BalancePayment_online_warehousesId_fkey";
...
-- DropTable
DROP TABLE "BalancePayment_online";
