...
-- CreateIndex
CREATE UNIQUE INDEX "ReceiptSettings_online_warehousesId_key" ON "ReceiptSettings_online"("warehousesId");
...
-- AddForeignKey
ALTER TABLE "ReceiptSettings_online" ADD CONSTRAINT "ReceiptSettings_online_warehousesId_fkey" FOREIGN KEY ("warehousesId") REFERENCES "Warehouses_online"("warehouseCode") ON DELETE RESTRICT ON UPDATE CASCADE;
