...
-- AddForeignKey
ALTER TABLE "ReceiptSettings_online" ADD CONSTRAINT "ReceiptSettings_online_warehouses_onlineId_fkey" FOREIGN KEY ("warehouses_onlineId") REFERENCES "Warehouses_online"("warehouseCode") ON DELETE SET NULL ON UPDATE CASCADE;
