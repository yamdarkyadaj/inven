        ...
        <div className="flex flex-1 flex-col gap-4 p-4 pt-0">
          ...
          <div className="grid gap-4 md:grid-cols-4">
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground">
                  {warehousesData.filter((w) => w.status === "active").length} active
                </p>
              </CardContent>
            </Card>
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">
                  {warehousesData.reduce((sum, w) => sum + w.capacity, 0).toLocaleString()}
                </div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">
                  {warehousesData.reduce((sum, w) => sum + w.currentStock, 0).toLocaleString()}
                </div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">{warehousesData.reduce((sum, w) => sum + w.assignedUsers, 0)}</div>
                ...
                <TableBody>
                  {filteredWarehouses.map((warehouse) => (
                    <TableRow key={warehouse.id}>
                      ...
                      <TableCell>{warehouse.assignedUsers}</TableCell>
